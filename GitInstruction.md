...
Системы Контроля Версий (SVN) - это программы, позволяющие управлять Вашими проектами (репозиториями).
Самая популярная, но далеко не единственная - GIT.
GitHub - сервис для работы с удалёнными репозиториями.
